      ...
      attributes: new foundry.data.fields.SchemaField({
        ...
        hp: new foundry.data.fields.SchemaField({
          value: new foundry.data.fields.NumberField({
            nullable: false, integer: true, min: 0, initial: 0, label: "MOJO.HitPointsCurrent"
          }),
          max: new foundry.data.fields.NumberField({
            nullable: true, integer: true, min: 0, initial: null, label: "MOJO.HitPointsOverride"
          }),
          ...
          bonuses: new foundry.data.fields.SchemaField({
            level: new FormulaField({deterministic: true, label: "MOJO.HitPointsBonusLevel"}),
            overall: new FormulaField({deterministic: true, label: "MOJO.HitPointsBonusOverall"})
          })
        }, {label: "MOJO.HitPoints"}),
        death: new foundry.data.fields.SchemaField({
          success: new foundry.data.fields.NumberField({
            required: true, nullable: false, integer: true, min: 0, initial: 0, label: "MOJO.DeathSaveSuccesses"
          }),
          failure: new foundry.data.fields.NumberField({
            required: true, nullable: false, integer: true, min: 0, initial: 0, label: "MOJO.DeathSaveFailures"
          })
        }, {label: "MOJO.DeathSave"}),
        exhaustion: new foundry.data.fields.NumberField({
          required: true, nullable: false, integer: true, min: 0, initial: 0, label: "MOJO.Exhaustion"
        }),
        inspiration: new foundry.data.fields.BooleanField({required: true, label: "MOJO.Inspiration"})
      }, {label: "MOJO.Attributes"}),
      details: new foundry.data.fields.SchemaField({
        ...DetailsFields.common,
        ...DetailsFields.creature,
        background: new foundry.data.fields.StringField({required: true, label: "MOJO.Background"}),
        originalClass: new foundry.data.fields.StringField({required: true, label: "MOJO.ClassOriginal"}),
        xp: new foundry.data.fields.SchemaField({
          value: new foundry.data.fields.NumberField({
            required: true, nullable: false, integer: true, min: 0, initial: 0, label: "MOJO.ExperiencePointsCurrent"
          })
        }, {label: "MOJO.ExperiencePoints"}),
        appearance: new foundry.data.fields.StringField({required: true, label: "MOJO.Appearance"}),
        trait: new foundry.data.fields.StringField({required: true, label: "MOJO.PersonalityTraits"}),
        ideal: new foundry.data.fields.StringField({required: true, label: "MOJO.Ideals"}),
        bond: new foundry.data.fields.StringField({required: true, label: "MOJO.Bonds"}),
        flaw: new foundry.data.fields.StringField({required: true, label: "MOJO.Flaws"})
      }, {label: "MOJO.Details"}),
      traits: new foundry.data.fields.SchemaField({
        ...TraitsFields.common,
        ...TraitsFields.creature,
        weaponProf: TraitsFields.makeSimpleTrait({label: "MOJO.TraitWeaponProf"}),
        armorProf: TraitsFields.makeSimpleTrait({label: "MOJO.TraitArmorProf"}),
        toolProf: TraitsFields.makeSimpleTrait({label: "MOJO.TraitToolProf"})
      }, {label: "MOJO.Traits"}),
      resources: new foundry.data.fields.SchemaField({
        primary: makeResourceField({label: "MOJO.ResourcePrimary"}),
        secondary: makeResourceField({label: "MOJO.ResourceSecondary"}),
        tertiary: makeResourceField({label: "MOJO.ResourceTertiary"})
      }, {label: "MOJO.Resources"})
    });
  }
...
function makeResourceField(schemaOptions={}) {
  return new foundry.data.fields.SchemaField({
    value: new foundry.data.fields.NumberField({
      required: true, integer: true, initial: 0, labels: "MOJO.ResourceValue"
    }),
    max: new foundry.data.fields.NumberField({
      required: true, integer: true, initial: 0, labels: "MOJO.ResourceMax"
    }),
    sr: new foundry.data.fields.BooleanField({required: true, labels: "MOJO.ShortRestRecovery"}),
    lr: new foundry.data.fields.BooleanField({required: true, labels: "MOJO.LongRestRecovery"}),
    label: new foundry.data.fields.StringField({required: true, labels: "MOJO.ResourceLabel"})
  }, schemaOptions);
}
