...
export default class DetailsField {
  ...
  static get common() {
    return {
      biography: new foundry.data.fields.SchemaField({
        value: new foundry.data.fields.HTMLField({label: "MOJO.Biography"}),
        public: new foundry.data.fields.HTMLField({label: "MOJO.BiographyPublic"})
      }, {label: "MOJO.Biography"})
    };
  }
  ...
  static get creature() {
    return {
      alignment: new foundry.data.fields.StringField({required: true, label: "MOJO.Alignment"}),
      race: new foundry.data.fields.StringField({required: true, label: "MOJO.Race"})
    };
  }
}
