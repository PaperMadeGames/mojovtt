 ...
 * @property {string} armor.type        Equipment type as defined in `MOJO.equipmentTypes`.
 ...
 * @property {string} baseItem          Base armor as defined in `MOJO.armorIds` for determining proficiency.
    ...
    return this.mergeSchema(super.defineSchema(), {
      armor: new foundry.data.fields.SchemaField({
        type: new foundry.data.fields.StringField({
          required: true, initial: "light", label: "MOJO.ItemEquipmentType"
        }),
        value: new foundry.data.fields.NumberField({required: true, integer: true, min: 0, label: "MOJO.ArmorClass"}),
        dex: new foundry.data.fields.NumberField({required: true, integer: true, label: "MOJO.ItemEquipmentDexMod"})
      }, {label: ""}),
      baseItem: new foundry.data.fields.StringField({required: true, label: "MOJO.ItemEquipmentBase"}),
      speed: new foundry.data.fields.SchemaField({
        value: new foundry.data.fields.NumberField({required: true, min: 0, label: "MOJO.Speed"}),
        conditions: new foundry.data.fields.StringField({required: true, label: "MOJO.SpeedConditions"})
      }, {label: "MOJO.Speed"}),
      strength: new foundry.data.fields.NumberField({
        required: true, integer: true, min: 0, label: "MOJO.ItemRequiredStr"
      }),
      stealth: new foundry.data.fields.BooleanField({required: true, label: "MOJO.ItemEquipmentStealthDisav"}),
