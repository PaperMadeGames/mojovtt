...
export default class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/mojo/templates/advancement/advancement-confirmation-dialog.hbs",
      jQuery: false
    });
  }
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("MOJO.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("MOJO.AdvancementDeleteConfirmationMessage"),
      {
  ...
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("MOJO.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("MOJO.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("MOJO.LevelActionDecrease")
      }
    );
  }
