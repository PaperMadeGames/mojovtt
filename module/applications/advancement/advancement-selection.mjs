...
export default class AdvancementSelection extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["mojo", "sheet", "advancement"],
      template: "systems/mojo/templates/advancement/advancement-selection.hbs",
      title: "MOJO.AdvancementSelectionTitle",
      width: 500,
      height: "auto"
    });
  }
  ...
  getData() {
    const context = { types: {} };
    for ( const [name, advancement] of Object.entries(CONFIG.MOJO.advancementTypes) ) {
    ...
    context.types = mojo.utils.sortObjectEntries(context.types, "label");
    return context;
  }
  ...
  static async createDialog(item, { rejectClose=false, options={} }={}) {
    return new Promise((resolve, reject) => {
      const dialog = new this(item, {
        title: `${game.i18n.localize("MOJO.AdvancementSelectionTitle")}: ${item.name}`,
        buttons: {
          submit: {
            callback: html => {
