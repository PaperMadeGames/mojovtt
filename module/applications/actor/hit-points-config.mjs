...
export default class ActorHitPointsConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["mojo", "actor-hit-points-config"],
      template: "systems/mojo/templates/apps/hit-points-config.hbs",
      width: 320,
      height: "auto",
      sheetConfig: false
    });
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("MOJO.HitPointsConfig")}: ${this.document.name}`;
  }
  ...
  async _onRollHPFormula(event) {
    ...
    try {
      ...
      ui.notifications.error(game.i18n.localize("MOJO.HPFormulaError"));
      throw error;
    }
  }
}
