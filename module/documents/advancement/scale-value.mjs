...
export default class ScaleValueAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      order: 60,
      icon: "systems/mojo/icons/svg/scale-value.svg",
      title: game.i18n.localize("MOJO.AdvancementScaleValueTitle"),
      hint: game.i18n.localize("MOJO.AdvancementScaleValueHint"),
      multiLevel: true,
