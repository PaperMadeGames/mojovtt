...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      order: 10,
      icon: "systems/mojo/icons/svg/hit-points.svg",
      title: game.i18n.localize("MOJO.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("MOJO.AdvancementHitPointsHint"),
      multiLevel: true,
  ...
  /** @inheritdoc */
  get levels() {
    return Array.fromRange(CONFIG.MOJO.maxLevel + 1).slice(1);
  }
