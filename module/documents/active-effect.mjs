...
export default class ActiveEffect5e extends ActiveEffect {
  ...
  apply(actor, change) {
    ...
    if ( change.key.startsWith("flags.mojo.") ) change = this._prepareFlagChange(actor, change);
  ...
  _prepareFlagChange(actor, change) {
    ...
    const data = CONFIG.MOJO.characterFlags[key.replace("flags.mojo.", "")];
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("MOJO.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("MOJO.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("MOJO.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("MOJO.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("MOJO.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("MOJO.EffectUnavailableInfo")]
      }
    };
