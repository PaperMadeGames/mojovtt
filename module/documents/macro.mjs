  ...
  switch ( dropData.type ) {
    case "Item":
      ...
      foundry.utils.mergeObject(macroData, {
        name: itemData.name,
        img: itemData.img,
        command: `mojo.documents.macro.rollItem("${itemData.name}")`,
        flags: {"mojo.itemMacro": true}
      });
      break;
    case "ActiveEffect":
      ...
      foundry.utils.mergeObject(macroData, {
        ...
        img: effectData.icon,
        command: `mojo.documents.macro.toggleEffect("${effectData.label}")`,
        flags: {"mojo.effectMacro": true}
      });
      break;
    default:
      return;
