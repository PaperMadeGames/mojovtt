...
export async function damageRoll({
  ...
  const roll = new CONFIG.Dice.DamageRoll(formula, data, {
    ...
    criticalMultiplier,
    criticalBonusDamage,
    multiplyNumeric: multiplyNumeric ?? game.settings.get("mojo", "criticalDamageModifiers"),
    powerfulCritical: powerfulCritical ?? game.settings.get("mojo", "criticalDamageMaxDice")
  });
